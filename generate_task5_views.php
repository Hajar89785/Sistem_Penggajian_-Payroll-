...
mkdir(__DIR__ . '/resources/views/payroll', 0777, true);
file_put_contents(__DIR__ . '/resources/views/payroll/index.blade.php', $payroll_index);
file_put_contents(__DIR__ . '/resources/views/payroll/show.blade.php', $payroll_show);

echo "Views for Task 5 generated successfully.\n";
